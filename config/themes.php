...
return [
    'light' => [
        ...
        '--be-destructive' => 'oklch(0.577 0.245 27.325)',

        '--be-border' => 'oklch(0.922 0 0)',
        '--be-input' => 'oklch(0.922 0 0)',
        '--be-ring' => 'oklch(0.708 0 0)',
    ...
    'dark' => [
        ...
        '--be-destructive' => 'oklch(0.704 0.191 22.216)',

        '--be-border' => 'oklch(1 0 0 / 10%)',
        '--be-input' => 'oklch(1 0 0 / 15%)',
        '--be-ring' => 'oklch(0.556 0 0)',
        ...
        '--be-sidebar-ring' => 'oklch(0.556 0 0)',
    ],
];
