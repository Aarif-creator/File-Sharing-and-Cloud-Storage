 ...
 */
import type {SendFileRequestEmailBodyEmailsItem} from './send-file-request-email-body-emails-item';

export type SendFileRequestEmailBody = {
  /**
   * @minItems 1
   * @maxItems 10
   */
  emails: SendFileRequestEmailBodyEmailsItem[];
};
