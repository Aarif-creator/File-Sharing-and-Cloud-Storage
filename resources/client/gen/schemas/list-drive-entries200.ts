 ...
 */
import type {DriveEntry} from './drive-entry';
import type {ListDriveEntries200Links} from './list-drive-entries200-links';
import type {ListDriveEntries200Meta} from './list-drive-entries200-meta';

export type ListDriveEntries200 = {
  data: DriveEntry[];
  links: ListDriveEntries200Links;
  meta: ListDriveEntries200Meta;
  folder: DriveEntry | null;
};
