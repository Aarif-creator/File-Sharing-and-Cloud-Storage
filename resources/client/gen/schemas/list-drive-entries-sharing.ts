...
export type ListDriveEntriesSharing =
  (typeof ListDriveEntriesSharing)[keyof typeof ListDriveEntriesSharing] | null;

export const ListDriveEntriesSharing = {
  shared_with_me: 'shared_with_me',
  shared_by_me: 'shared_by_me',
  has_shareable_link: 'has_shareable_link',
} as const;
