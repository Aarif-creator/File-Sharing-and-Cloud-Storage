 ...
 */
import type {GetShareableLinkPageData200FolderChildren} from './get-shareable-link-page-data200-folder-children';
import type {ShareableLink} from './shareable-link';

export type GetShareableLinkPageData200 = {
  data: ShareableLink | null;
  /** @nullable */
  folderChildren: GetShareableLinkPageData200FolderChildren;
