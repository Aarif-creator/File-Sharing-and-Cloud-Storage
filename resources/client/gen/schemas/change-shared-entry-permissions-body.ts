 ...
 */
import type {ChangeSharedEntryPermissionsBodyPermissions} from './change-shared-entry-permissions-body-permissions';

export type ChangeSharedEntryPermissionsBody = {
  permissions: ChangeSharedEntryPermissionsBodyPermissions;
  user_id: number;
};
