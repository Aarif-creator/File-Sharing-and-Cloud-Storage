 ...
 */
import type {DriveEntryUsersItemEntryPermissions} from './drive-entry-users-item-entry-permissions';

export type DriveEntryUsersItem = {
  id: number;
  email: string;
  /** @nullable */
  name: string | null;
  ...
  image: string | null;
  owns_entry: boolean;
  entry_permissions: DriveEntryUsersItemEntryPermissions;
};
